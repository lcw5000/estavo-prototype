...
export const contacts = [
  {
    ...
    showings: 2,
    wishlist: ['147 Oak St, Noe Valley', '112 Sanchez St, Noe Valley'],
    notes: 'Pre-approval letter on file. Wife involved in decisions but not on the inquiry. Prefers weekend viewings. Needs to sell current condo first — not a blocker.',
  ...
  },
  {
    ...
    showings: 0,
    wishlist: ['22 Clipper St, Castro'],
    notes: 'First contact was very warm. Seems ready to move fast. No lender yet — good chance to refer. Showing scheduled Sunday 11am.',
  ...
  },
  {
    ...
    lastContactDate: '2026-04-23',
    showings: 6,
    wishlist: ['14 Oak Street (under contract)', '22 Clipper St (passed)', '88 Sanchez St (passed)'],
    notes: 'Very thorough buyers — Linda makes the final call. Inspection April 28 with John Mills. HOA docs still outstanding from seller.',
  ...
  },
  {
    ...
    showings: 1,
    wishlist: ['1420 Mission St', '88 Sanchez St', '204 Clipper St'],
    notes: 'Missed last call — left voicemail. Responds much better to text than phone. Partner may be involved in decision.',
  ...
  },
  {
    ...
    showings: 0,
    wishlist: [],
    notes: 'Opens every market report but rarely clicks listings. Replied once asking about the Sunset market shift. Very low urgency — monthly drip only.',
  ...
  },
  {
    ...
    lastContactDate: null,
    showings: 0,
    wishlist: ['88 Sanchez St', '1404 Bernal Ave'],
    notes: '',
  ...
  },
  {
    ...
    lastContactDate: null,
    showings: 0,
    wishlist: ['88 Sanchez St'],
    notes: 'Came to open house alone. Asked detailed questions about HOA fees and recent price reductions — more engaged than he let on.',
